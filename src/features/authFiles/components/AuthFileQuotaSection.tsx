...
const getQuotaConfig = (type: QuotaProviderType) => {
  ...
  if (type === 'minimax') return MINIMAX_CONFIG;
...
export function AuthFileQuotaSection(props: AuthFileQuotaSectionProps) {
  ...
  const quota = useQuotaStore((state) => {
    ...
    if (quotaType === 'minimax') return state.minimaxQuota[file.name] as QuotaState;
  ...
  const updateQuotaState = useQuotaStore((state) => {
    ...
    if (quotaType === 'minimax') return state.setMinimmaxQuota as unknown as (updater: unknown) => void;
